...
function ScoopVisual({ colors, image, size = "card", soldOut = false }) {
  const [a, b, c] = colors;
  if (image) {
    return (
      <div
            ...
            return (
              ...
              >
                <div style={{ width: "100%", aspectRatio: "1 / 1" }}>
                  <ScoopVisual colors={p.colors} image={p.image} soldOut={soldOut} />
                </div>
                <div>
                  <div
                    style={{
        ...
        >
          <div style={{ maxWidth: 560, margin: "0 auto", padding: "20px 20px 100px" }}>
            ...
            <div style={{ width: "100%", aspectRatio: "1 / 1", borderRadius: 24, overflow: "hidden" }}>
              <ScoopVisual colors={activeProduct.colors} image={activeProduct.image} size="detail" soldOut={activeProduct.stock <= 0} />
            </div>
                ...
                cartLines.map((l) => (
                  ...
                  >
                    <div style={{ width: 60, height: 60, borderRadius: 12, overflow: "hidden", flexShrink: 0 }}>
                      <ScoopVisual colors={l.product.colors} image={l.product.image} />
                    </div>
